...
/**
 * Manages all audio playback including music with crossfading and sound
 * effects.<br>
...
public class AudioManager {
	...
	public AudioManager(AssetManager assetManager) {
		...
		System.out.println("AudioManager initialized. Master: " + _masterVolume + ", Music: " + _musicVolume + ", SFX: "
				+ _sfxVolume);
	}
	 ...
	 * @return Cached or newly created AudioNode template configured for SFX
	 *         playback
	 */
	...
	/**
	 * Clear all cached SFX template nodes. Call when the application shuts down or
