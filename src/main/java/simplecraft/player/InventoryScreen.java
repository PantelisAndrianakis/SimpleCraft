...
public class InventoryScreen implements ActionListener
{
	...
	private void buildPlayerModel(SimpleCraft app)
	{
		...
		final Material ironMat = makeModelMaterial(COLOR_IRON, app);
		final Material ironDarkMat = makeModelMaterial(COLOR_IRON_DARK, app);
		final Material ironLightMat = makeModelMaterial(COLOR_IRON_LIGHT, app);
	...
	private void updatePlayerModelOverlays()
	{
		...
		// Hide hair when helmet covers it.
		...
		// Hide brown pants when iron pants are worn.
		...
		// Hide brown waistband when chestplate or pants cover it.
